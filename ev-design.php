...
<div style="background:#fff;padding:20px;border-radius:14px;box-shadow:0 5px 20px rgba(0,0,0,0.05);">
...
<div>
<h4 style="margin:0;color:#19a463;text-align:center;font-size: 1.25rem;
    line-height: 1.75rem;font-weight:bold;">40%</h4>
<p style="font-size:13px;color:#6b7280;margin:0;">Lower Fuel Costs</p>
</div>

<div>
<h4 style="margin:0;color:#19a463;text-align:center;font-size: 1.25rem;
    line-height: 1.75rem;font-weight:bold;">Zero</h4>
<p style="font-size:13px;color:#6b7280;margin:0;">Tailpipe Emissions</p>
</div>

<div>
<h4 style="margin:0;color:#19a463;text-align:center;font-size: 1.25rem;
    line-height: 1.75rem;font-weight:bold;">98%</h4>
<p style="font-size:13px;color:#6b7280;margin:0;">Fleet Uptime</p>
</div>

<div>
<p style="margin:0;color:#19a463;text-align:center;font-size: 1.25rem;
    line-height: 1.75rem;font-weight:bold;">3x</p>
<p style="font-size:13px;color:#6b7280;margin:0;">Longer Asset Life</p>
</div>
